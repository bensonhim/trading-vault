...
>
> - **20% Study (bullish):** 22
> - **20% Study (bearish):** 108
> - **T2108:** 53.5%
> - **Net Primary:** -53
> - **Breakouts:** 98 | **Breakdowns:** 748
> - **Follow-through:** 3d=24.4% 5d=15.6% (FAILING)
>
> - 5-day ratio 0.46 < 0.8
> - 10-day ratio 0.55 < 0.8
> - Monthly 25% ratio 0.39 < 0.8
> - Breakdown spike: 748 vs 98
> - Breakdown (748) > Breakout (98) = selling pressure
...
| Indicator | 2026-02-05 | 2026-02-05 | 2026-02-04 | 2026-02-04 | 2026-02-03 | Trend |
|-----------|-------|-------|-------|-------|-------|-------|
| Net Primary | -53 | -53 | +280 | +280 | +352 | — |
| T2108 | 53.47% | 53.47% | 57.83% | 57.83% | 55.88% | — |
| Breakouts | 98 | 98 | 279 | 279 | 326 | — |
| Breakdowns | 748 | 748 | 505 | 505 | 537 | — |
| BO:BD Ratio | 0.13 | 0.13 | 0.55 | 0.55 | 0.61 | — |

### Secondary Indicators

| Indicator | 2026-02-05 | Signal | Interpretation |
|-----------|---------|--------|----------------|
| Monthly 25% Up | 117 | Normal | Stocks up 25%+ in a month |
| Monthly 25% Down | 300 | Elevated | Stocks down 25%+ in a month |
| Monthly 25% Ratio | 0.39
Below 1.0 | Bearish tilt |
| Fib 13% Up (34d) | 1423 | Normal | Stocks up 13%+ in 34 days |
| Fib 13% Down (34d) | 1898 | High | Stocks down 13%+ in 34 days |
| Fib 13% Ratio | 0.75
Below 1.0 | Bearish medium-term |
| 5-Day Ratio | 0.46 | Below 1.0 | Short-term weakness |
| 10-Day Ratio | 0.55 | Below 1.0 | Sustained weakness |
...
- Breakdown spike: 748 vs 98 (ratio 0.13)
...
RS_20d: -1.69 | RS_65d: 7.05

### Sector RS Heatmap (grouped by theme, top 10)

| Rank | Ticker | Theme | RS_20d | RS_65d | ETF 20d | SPY 20d | Excess | Status |
|------|--------|-------|--------|--------|---------|---------|--------|--------|
| 1 | FINX | fintech | 12.86 | 79.46 | -22.3% | -1.7% | -20.6% |  |
| 2 | BLOK | blockchain | 10.24 | 75.38 | -17.8% | -1.7% | -16.0% |  |
| 3 | SKYY | cloud_computing | 10.14 | 67.64 | -17.6% | -1.7% | -15.9% |  |
| 4 | BUG | cybersecurity | 8.89 | 66.08 | -15.4% | -1.7% | -13.7% |  |
| 5 | AIQ | ai_tech | 4.51 | 24.04 | -7.8% | -1.7% | -6.1% |  |
| 6 | GNOM | genomics | 4.24 | -1.43 | -7.4% | -1.7% | -5.6% | TOP FORMING |
| 7 | QTUM | quantum_computing | 3.05 | 10.99 | -5.3% | -1.7% | -3.6% |  |
| 8 | XLF | financials_broad | 2.40 | -5.89 | -4.2% | -1.7% | -2.4% |  |
| 9 | XLV | healthcare_broad | 1.74 | -21.78 | -3.0% | -1.7% | -1.3% |  |
| 10 | XLY | consumer_discretionary | 1.62 | 5.18 | -2.8% | -1.7% | -1.1% |  |
...
|--------|------|---------|--------|---------|-------|
| HIMS | +9.8% | -3.8% | 71,253,500 | -21% | fresh |
| SIRI | +8.2% | +9.0% | 25,624,218 | +13% | fresh |
| TENB | +6.8% | +0.2% | 11,370,335 | -8% | fresh |
| TPR | +6.1% | +10.2% | 6,513,800 | +12% | fresh |
| HSY | +6.3% | +9.0% | 5,700,300 | +18% | fresh |
| ELF | +8.7% | -9.2% | 5,552,800 | -10% | fresh |
| FORM | +8.6% | +17.2% | 3,841,100 | +14% | fresh |
| CAH | +4.9% | +9.8% | 3,583,600 | +8% | LARGE-CAP |
| AMSC | +15.0% | -6.0% | 3,549,139 | -17% | fresh |
| EZPW | +6.5% | +4.5% | 3,456,300 | +9% | fresh |
| OSW | +6.5% | +2.9% | 3,227,700 | +6% | fresh |
| CE | +4.2% | -1.4% | 2,890,300 | +15% | fresh |
| ITT | +8.2% | +9.1% | 2,814,227 | +9% | fresh |
| ALGN | +9.2% | +8.9% | 2,674,535 | +7% | fresh |
| TRUG | +6.2% | +29.3% | 2,258,002 | +20% | fresh |
...
|------|-----------|----------------|---------|
| 2026-01-02 | 40% | bullish/REDUCE_SIZE | SPY rose 1.6% over 5 days |
| 2026-01-02 | 40% | bullish/REDUCE_SIZE | SPY rose 1.6% over 5 days |
...
|--------|-------|----------|-------|------|-------|
| PEGA | -36.8% | -16.0% | $25.99 | $27.48 | unknown_negative (gap_down) |
...
- [ ] **Focus on SIPs** — 25 fresh catalyst stocks for day trade
