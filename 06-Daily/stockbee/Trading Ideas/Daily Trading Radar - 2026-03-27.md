...
> - **T2108:** 22.1%
> - **Net Primary:** -523
> - **Breakouts:** 146 | **Breakdowns:** 331
> - **Follow-through:** 3d=29.6% 5d=34.8% (FAILING)
>
> - 5-day ratio 0.72 < 0.8
> - 10-day ratio 0.74 < 0.8
> - Monthly 25% ratio 0.45 < 0.8
> - Breakdown spike: 331 vs 146
> - TI65 bullish universe 703 < 800 (market losing momentum)
...
| Indicator | 2026-03-26 | 2026-03-26 | 2026-03-25 | 2026-03-25 | 2026-03-24 | Trend |
|-----------|-------|-------|-------|-------|-------|-------|
| Net Primary | -523 | -523 | -397 | -397 | -523 | — |
| T2108 | 22.12% | 22.12% | 24.53% | 24.53% | 22.97% | — |
| Breakouts | 146 | 146 | 320 | 320 | 223 | — |
| Breakdowns | 331 | 331 | 113 | 113 | 285 | — |
| BO:BD Ratio | 0.44 | 0.44 | 2.83 | 2.83 | 0.78 | — |

### Secondary Indicators

| Indicator | 2026-03-26 | Signal | Interpretation |
|-----------|---------|--------|----------------|
| Monthly 25% Up | 102 | Normal | Stocks up 25%+ in a month |
| Monthly 25% Down | 226 | Elevated | Stocks down 25%+ in a month |
| Monthly 25% Ratio | 0.45
Below 1.0 | Bearish tilt |
| Fib 13% Up (34d) | 1010 | Normal | Stocks up 13%+ in 34 days |
| Fib 13% Down (34d) | 2223 | High | Stocks down 13%+ in 34 days |
| Fib 13% Ratio | 0.45
Below 1.0 | Bearish medium-term |
| 5-Day Ratio | 0.72 | Below 1.0 | Short-term weakness |
...
- Breakdown spike: 331 vs 146 (ratio 0.44)
...
| Metric | Value | Signal |
|--------|-------|--------|
| Stocks up 20%+ (5d) | 36 | Marginal |
| Stocks down 20%+ (5d) | 21 | Normal |

> [!warning] Scan Suppression Active: SOS, DEP, ANTS
> 20% study at 36 — breakouts unlikely to follow through in this environment.

**Breakout Follow-Through (last 10 days):** 3d=29.6% 5d=34.8% [FAILING]
...
RS_20d: 0.99 | RS_65d: 1.97

### Sector RS Heatmap (grouped by theme, top 10)

| Rank | Ticker | Theme | RS_20d | RS_65d | ETF 20d | SPY 20d | Excess | Status |
|------|--------|-------|--------|--------|---------|---------|--------|--------|
| 1 | SIL | silver_miners | 4.94 | 0.64 | -30.4% | -6.2% | -24.2% |  |
| 2 | ITB | home_construction | 2.53 | 1.58 | -15.6% | -6.2% | -9.4% |  |
| 3 | DRIV | ev_automotive | 1.60 | -0.15 | -9.8% | -6.2% | -3.7% |  |
| 4 | GNOM | genomics | 1.53 | 1.38 | -9.4% | -6.2% | -3.2% |  |
| 5 | PAVE | infrastructure | 1.52 | -0.80 | -9.4% | -6.2% | -3.2% |  |
| 6 | QTUM | quantum_computing | 1.36 | 0.49 | -8.4% | -6.2% | -2.2% |  |
| 7 | AIQ | ai_tech | 1.32 | 1.70 | -8.1% | -6.2% | -2.0% |  |
| 8 | BLOK | blockchain | 1.30 | 2.86 | -8.0% | -6.2% | -1.9% |  |
| 9 | SOXX | semiconductors | 1.26 | -1.97 | -7.8% | -6.2% | -1.6% |  |
| 10 | PPA | aerospace_defense | 1.15 | -1.47 | -7.1% | -6.2% | -0.9% |  |
...
|--------|------|---------|--------|---------|-------|
| BATL | +27.0% | +6.3% | 44,157,034 | -57% | fresh |
| NEXT | +7.8% | +11.0% | 13,687,400 | +12% | fresh |
| DXYZ | +5.5% | -2.5% | 7,399,700 | +19% | fresh |
| HNRG | +6.3% | +4.2% | 2,745,712 | +9% | fresh |
| BOXL | +11.7% | +24.3% | 1,793,783 | +15% | fresh |
| SMJF | +4.5% | +8.9% | 1,621,645 | +6% | fresh |
| EEIQ | +75.5% | +209.2% | 112,647,002 | +278% | EXTENDED |
| AIFF | +22.6% | +79.8% | 109,821,900 | +39% | EXTENDED; DILUTION |
| LNAI | +129.3% | +23.1% | 32,204,637 | +28% | EXTENDED; DILUTION |
| PGEN | +31.3% | +25.5% | 23,541,517 | +17% | DILUTION |
| NAVN | +23.1% | +43.3% | 21,264,100 | +44% | EXTENDED |
| OXY | +0.8% | +4.0% | 20,658,935 | +8% | LARGE-CAP |
| HTZ | -0.7% | +9.2% | 19,172,600 | +20% | fresh |
| KOD | +55.6% | +74.8% | 13,184,300 | +75% | EXTENDED |
| FIG | -0.5% | +5.0% | 12,794,709 | -9% | fresh |
...
|--------|-------|----------|-------|------|-------|
| PEGA | -40.2% | -16.0% | $25.99 | $27.48 | unknown_negative (gap_down) |
