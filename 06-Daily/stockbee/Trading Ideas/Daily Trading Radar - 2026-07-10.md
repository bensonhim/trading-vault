...
> - **Follow-through:** 3d=40.3% 5d=31.1% (OK)
>
> - 20% study at 23 (< 30) = funds not aggressively buying, breakouts unlikely to follow through
> - 20% study at 23 (< 30) + Net Primary +425 + 5d ratio 0.80 — all indicators weak, downgraded to RANGE_BOUND/SIPs_ONLY.
...
| Indicator | 2026-07-09 | 2026-07-09 | 2026-07-08 | 2026-07-08 | 2026-07-07 | Trend |
|-----------|-------|-------|-------|-------|-------|-------|
| Net Primary | +425 | +425 | +313 | +313 | +453 | — |
| T2108 | 49.81% | 49.81% | 48.05% | 48.05% | 50.37% | — |
| Breakouts | 250 | 250 | 185 | 185 | 189 | — |
| Breakdowns | 100 | 100 | 309 | 309 | 476 | — |
| BO:BD Ratio | 2.50 | 2.50 | 0.60 | 0.60 | 0.40 | — |
...
**Breakout Follow-Through (last 10 days):** 3d=40.3% 5d=31.1% [OK]
...
RS_20d: 11.18 | RS_65d: 1.93

### Sector RS Heatmap (grouped by theme, top 10)

| Rank | Ticker | Theme | RS_20d | RS_65d | ETF 20d | SPY 20d | Excess | Status |
|------|--------|-------|--------|--------|---------|---------|--------|--------|
| 1 | XBI | biotech_small | 11.18 | 1.93 | +25.2% | +2.2% | +22.9% | LEADING |
| 2 | BUG | cybersecurity | 9.09 | 4.04 | +20.5% | +2.2% | +18.2% |  |
| 3 | FINX | fintech | 3.46 | 0.72 | +7.8% | +2.2% | +5.5% |  |
| 4 | XLF | financials_broad | 2.77 | 0.82 | +6.2% | +2.2% | +4.0% |  |
| 5 | XLV | healthcare_broad | 2.39 | 0.79 | +5.4% | +2.2% | +3.1% |  |
| 6 | SKYY | cloud_computing | 1.81 | 1.92 | +4.1% | +2.2% | +1.8% |  |
| 7 | SOXX | semiconductors | 1.57 | 4.81 | +3.5% | +2.2% | +1.3% |  |
| 8 | XLI | industrials_broad | 1.51 | 0.72 | +3.4% | +2.2% | +1.1% |  |
| 9 | XLU | utilities | 1.45 | -0.11 | +3.3% | +2.2% | +1.0% |  |
| 10 | XLK | technology_broad | 1.18 | 2.48 | +2.7% | +2.2% | +0.4% |  |
...
| NBIS | +5.9% | -0.1% | 13,994,705 | -6% | fresh |
...
|------|-----------|----------------|---------|
| 2026-05-22 | 64% | cautious/REDUCE_SIZE | SPY rose 1.7% over 5 days |
| 2026-05-22 | 64% | cautious/REDUCE_SIZE | SPY rose 1.7% over 5 days |
| 2026-05-26 | 60% | bullish/FULL_LONG | SPY rose 1.2% over 5 days |
...
|--------|-------|----------|-------|------|-------|
| ZCMD | 50.8% | -18.41% | $3.50 | $4.98 | unknown_negative (intraday_down) |
| STM | 0.0% | -15.62% | $55.50 | $56.42 | unknown_negative (intraday_down) |
| TSLA | -13.5% | -12.44% | $327.48 | $341.86 | unknown_negative (gap_down) |
