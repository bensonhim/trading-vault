...
date: 2026-07-14
tags: [daily, trading-radar, stockbee, pradeep-ultratrader, full-bull, full-long, dep, aapl, nke, tech, sos, googl, gs, afrm, bug]
---
...
> Net primary positive, T2108 at 52.25%, cybersecurity (BUG) overtakes biotech as leading sector with +23.1% 20d return. Multiple 6/6 Two Lynch SOS breakouts (GOOGL, GOOG, GS). Full playbook.
...
**Leading Sector:** BUG (cybersecurity) — RS_20d: 14.25 | RS_65d: 6.50
...
| Metric | Value |
|--------|-------|
| Days since last market low | 0 (T2108 at 52.25%, not in low zone) |
| Mature (3+ days) | No |
| Overbought (20% > 50) | No |
| Extended | No |
...
|---|--------|-------|----------|
| 1 | AAPL | $314.86 | highest |
| 2 | AMZN | $247.49 | highest |
| 3 | NFLX | $73.53 | high |
| 4 | CPRX | $31.49 | highest |
| 5 | HBAN | $17.85 | highest |
...
|--------|------|---------------|------|-------|---------------|---------------|
| AAPL | B | $323.77 | $315.68 | 2.50% | 7d, 5.36% width | Jul 2 (12d ago) |
| NKE | B | $45.14 | $44.01 | 2.50% | 8d, 7.65% width | Jul 1 (13d ago) |
| TECH | B | $71.49 | $70.35 | 1.59% | 10d, 1.28% width | Jun 25 (19d ago) |
| APGE | B | $134.00 | $132.27 | 1.29% | 10d, 1.0% width | Jun 22 (22d ago) |

### ANTS BSLO Orders (top 5 of 35)

| Ticker | Trigger (BSLO) | Notes |
|--------|----------------|-------|
| AAPL | $318.01 (+1%) | Tight day, 5000+ funds, Liquid Glamour |
| AMZN | $249.97 (+1%) | Tight day, 5000+ funds, Liquid Glamour |
| CPRX | $31.80 (+1%) | Tight day, biotech sector (leading) |
| HBAN | $18.03 (+1%) | Tight day, financials sector |
| NFLX | $74.27 (+1%) | Tight day, communications sector |
...
|--------|---------------|-----------|-----|------------|--------|-------|
| GOOGL | prev_close × 1.04 | 6/6 | 1st | No | 18.2M | 5000+ funds, perfect TL score |
| GOOG | prev_close × 1.04 | 6/6 | 1st | No | 11.2M | 5000+ funds, perfect TL score |
| GS | prev_close × 1.04 | 6/6 | 1st | No | 3.7M | +9.0% move, financials sector |
| AFRM | prev_close × 1.04 | 6/6 | 1st | No | 3.3M | Fintech sector, +3.1% move |
| HWM | prev_close × 1.04 | 6/6 | 1st | No | 1.6M | Industrials, perfect TL score |

> [!tip] All 5 top SOS candidates have perfect 6/6 Two Lynch scores and are first-leg breakouts. This is a very high-quality breakout day.
...
> [!note] Historical context is mixed — 1 positive, 1 flat. Similar conditions led to slight positive to flat market action.
...
**DEP Setup:** Breakout Jul 2 (+4.8%), 7-day consolidation, 5.36% width
...
**Assessment:** Last breakout SUCCESS. AAPL also appears in ANTS (tight day at $314.86). Can place both DEP limit and ANTS BSLO.

---

### TECH — Biotechnology | XBI | $11.2B | 1000+ funds

**DEP Setup:** Breakout Jun 25 (+19.3% earnings gap), 10-day consolidation, 1.28% width (extremely tight)
...
**Assessment:** 3 SUCCESS + 1 PROFIT_80_20 in last 5 swings. Biotech sector leading. Extremely tight consolidation (1.28%). Earnings gap catalyst on Jun 25.
...
**Assessment:** +46.7% breakout (major catalyst). 1.0% consolidation width — extremely tight. Biotech sector leading. High risk, high reward.

---

## 11. Action Summary

- [ ] Full playbook — 5 SOS candidates with 6/6 Two Lynch scores (GOOGL, GOOG, GS, AFRM, HWM)
- [ ] Place DEP limit orders before open: AAPL $323.77, NKE $45.14, TECH $71.49
- [ ] Monitor SOS intraday: GOOGL (18M vol, 6/6 TL), GS (+9.0%, 6/6 TL)
- [ ] Place ANTS BSLO orders: AAPL, AMZN, CPRX, HBAN, NFLX + 30 more
- [ ] Cybersecurity (BUG) is now leading sector — watch for cybersecurity setups
- [ ] Biotech (XBI) still strong — TECH and APGE are in the leading sector
