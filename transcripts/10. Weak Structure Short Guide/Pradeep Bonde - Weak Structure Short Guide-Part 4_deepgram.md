---
title: Pradeep Bonde - Weak Structure Short Guide-Part 4
source: https://stockbee-videos.b-cdn.net/2022-10-12-WSS-part4/2022-10-12-WSS-part4.mp4
language: en
backend: deepgram
...
# Pradeep Bonde - Weak Structure Short Guide-Part 4
...
How to create a watch list for a weak structure short?
...
Like, say, in this particular case now, there is a waterfall decline.

The stock had one day bounce, which is less than 41%.

So this particular stock goes on your watch list.
...
They're looking for stocks which are down 20% plus.

In this case, then look for a stock which is up.

Right?

And you don't want, like, stocks up 98%.

So you start looking at stocks which are down less than 2.5% and see if they are weak structure short.

And then you can create a watch list from this particular thing also.
...
So it is not a weak structure short.
...
See here now, this is a waterfall decline.

It's just having one day bounce, so that can go into your watch list.

Like, you'll have to go through everything to find this kind of a thing.

The third thing where you can create a watch list from is TI 65 bearish.

In TI 65 bearish, the stocks are down.

Right?

And basically or they have a negative momentum.
...
And you can create a watch list and operate from watch list per week.
