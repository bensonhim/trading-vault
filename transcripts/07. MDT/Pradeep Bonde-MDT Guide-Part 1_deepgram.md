---
title: Pradeep Bonde-MDT Guide-Part 1
source: https://stockbee-videos.b-cdn.net/Modified%20DT%20Guide%20Pat%201/Modified%20DT%20Guide%20Pat%201.mp4
language: en
backend: deepgram
...
# Pradeep Bonde-MDT Guide-Part 1
...
So that's why it's called modified double trouble.
...
So you can use MDT for creating a relative strength.

So let's go to TC2000.

Let's try and understand what is really MDT.

In order to understand MDT, MDT, as I said, is a way of basically ranking stocks.

Right?

And I'm going to show you how to use it for ranking first.

And I'm also going to show you how to use it for just like creating, an absolute momentum also.

So let's look at like, say here.

Now, MDT is a ratio of price to one hundred and twenty six days.

Average moving average of one hundred and twenty six days.

So in order to do that, let's add a column here, which we are going to call it as MDT, right?

Insert column, value column.

And I'm going to write a formula for that.

And C divided by average C, 126.
...
So if you want to use MDT, there are many ways to use MDT.

One of the ways to use MDT is to rank stocks.

And the stocks higher ranked by MDT are the strongest stocks.

As you can see, this is a very strong stock, which made a big gap.

And this stock is likely to break out again to the upside.
...
This is the weakest stock in the market.
