---
title: Pradeep Bonde - DT Guide-Part 3
source: https://stockbee-videos.b-cdn.net/DT%20Guide%20Part%203/DT%20Guide%20Part%203.mp4
language: en
backend: deepgram
...
Double trouble is a method, momentum based method, which is based on Darwaz's book.

I created this method when I read the Darwaz's book.

In this method, what Darwaz was looking at is one of the first criteria for looking at a stock which she decided to trade was a stock which has at least doubled from fifty two week low.

And then after that, he had other criterias, which were like more elaborate criterias to select those stocks.

And those stocks, when they're forming a base near the high, within 20% of their high, is what he was looking for.

So in order to find this kind of a stock, let's write a scan or a combination scan, which is going to find for you the Darawas kind of stocks.

In order to do that, let's go to my TC2000.

And when we go to my TC2000, let's go to a new combo list, right?

New combo list.

We are going to name this combo list DT for double trouble.

Add to this US stocks.

We're going to add to this ETFs, if you want ETFs.

I would say, like, in a stick to US stocks, but American deposit to reduce it.

Now, what we are going to do is we are going to write the condition which Darwa's mimics the Darwa's thinking, and this is min low two fifty two is greater than or equal to 1.8.

Right?

Now, in addition to this condition, you want to add certain conditions.

You don't want to be doing this on a stock, which is 1¢ because if it goes to 2¢, it's going to show up.

So we'll do this for c is greater than or equal to 3.

So that way, we are eliminating stocks below three.

And you also want, in addition to this condition, you want a condition which is liquidity because you don't want to be looking at very illiquid stocks.

So for that, we'll add our standard liquidity condition.

Mainly, 3.1 is greater than or equal to 100,000, which essentially means that this stock has traded 100,000 shares in each of the last three days.

Now once we put this condition and once we run this scan, what we'll find is that you have 351 stocks which are showing up here, and we can move this and tab here.

Now, you have a DT scan.
...
What you can do is you can add a column here.
...
But that's like, the way the price was.

But here, you will see that this stock is the second strongest stock.
...
And this is a very strong stock.

Now it is it was forming a box here, and from the box, it had a breakout here, but obviously, the bearish market again, remember, if you remember Darwaz's book, Darwaz was very clearly saying that Darwaz's method in rising market.

So Darwaz was using his double trouble kind of a scan in situational awareness where the market was bullish.

So keep that in mind, right?

But you are going to find stocks like this using this scan.

And in the next set of video, or next video, I'm going to show you how and who, which kind of a trader can benefit by using DT Scan.

For that, we will have the next video.
