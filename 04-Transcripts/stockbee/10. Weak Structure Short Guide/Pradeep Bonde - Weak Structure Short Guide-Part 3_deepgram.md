---
title: Pradeep Bonde - Weak Structure Short Guide-Part 3
source: https://stockbee-videos.b-cdn.net/2022-10-12-WSS-part3/2022-10-12-WSS-part3.mp4
language: en
backend: deepgram
...
# Pradeep Bonde - Weak Structure Short Guide-Part 3
...
See curated note: [[10. Weak Structure Short Guide|WSS Guide]]

## Full Transcript

Where to put a stop on a weak structure shot?
...
So your stop can go at the high of the day, but, like, that can be a wide stop.
...
As you can see in this particular case, that's what happens.

Right?

So we're putting a very close stop.

I would recommend half of the day's range kind of a stop for this.

So this is like, you know, whatever was the range here.

$3, you can put a stop after your entry, $1.5 above your entry, and it works.
...
If they're not going to work, you can get stopped out for a very small loss.

Right?

Putting in a wider stop is not necessary at all.
...
So if they come back, that's not a good setup.
...
Again, I look at, like, in a moving my stop very close.

Half of the days, the second day's range kind of a thing.

And then if it gaps down, it's much better, to, like, again, move your stop, to protect your profit.

Right?

And many times, like in this case, it worked for five days.

Many times, they'll work for three days.

So, essentially, on third day, take a call.
...
Or you can take partial profit and let partial run.
...
So that's how you can handle these weak structure short stops very easily.
