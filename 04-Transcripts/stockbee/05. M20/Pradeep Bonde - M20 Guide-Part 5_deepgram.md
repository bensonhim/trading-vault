---
title: Pradeep Bonde - M20 Guide-Part 5
source: https://stockbee-videos.b-cdn.net/M20%20Guide%20Part%205/M20%20Guide%20Part%205.mp4
language: en
backend: deepgram
...
# Pradeep Bonde - M20 Guide-Part 5
...
Add a column called n c.

This n c is just a simple column, which is absolute c minus c one.

So how much is the difference between today's price to yesterday's price?
...
This is a buyout, right?

And that's not what you're interested.

But here is a stock, which was going down.

Right?

The direction of the momentum changed because it had this big, 20% kind of a move.

And now it is having an orderly pullback.

So that's the kind of stocks which you want to find.

And like this, if you keep going down and keep looking at stocks, you'll find CBD.

Again, the direction changed.

It had an orderly pullback.

Now I went through this entire list like this, sorted by this.

It makes your job very quick because once the NC increases, these are not most of the time, they are not good stocks.

So you can quickly start doing your work by NC.

Now here are stocks which I found using this particular scan, which are likely to break out in few days.

So you have PROS, which is setting up very nicely, first leg, and going sideways.

Right?

Similarly, this is pulling back, but it is not as good, so you can reduce that.

BCTX had had this momentum, and it's going sideways.

Aurora Sur has momentum, has got a minor pullback.

DHX.

See here, there's a lot of buying came in.

Now this is a very orderly pullback, which is happening in this stock and likely to break out from this.

Azure, Lancaster.

Third, Therm, Diane Therapeutics.

Again, like in here, there's a buying edge came in, and this is very orderly pullback.

Right?

Tesla, again, there is buying which has come in, going sideways.

Right?

So you can set up you can find stocks like this, which are setting up very nicely for a possible a possible upside.

Here, there was a catalyst stock, made a big move, and then pulling back.
...
So use M20 in the night, go through the list, create your watch list.
...
And if some of them you can enter in anticipation of a record.

And that way, if you do it, you will find bullish setups.
