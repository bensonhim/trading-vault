...
| Guide | Relationship |
|---|---|
| [[04. TI65 Guide|TI65]] | Use the DT list as the **base universe** for TI65 anticipation scans — DT confirms the stock has proven strength; TI65 confirms the trend velocity |
| [[05. M20 Guide|M20]] | M20 catches stocks **turning** from bottoms; DT confirms they have **already doubled** from those bottoms |
| [[Bullish Momentum Burst Guide-Section 1|BMB Section 1]] | DT stocks that form a box and break out are classic momentum burst setups — the box is the consolidation, the breakout is the burst |
...
- [[Bullish Momentum Burst Guide-Section 1|BMB Section 1]]
